...
public class restartIntervalCmd implements ARestartCommandInterface {
    @Override
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        ARestartConfig.updateConfig(Main.instance, delay, "autoRestart");
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&e[&4Server&e]&f")
                + ChatColor.BLUE + "The server will now restart every " + delay  + " minutes!");
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&e[&4Server&e]&f")
